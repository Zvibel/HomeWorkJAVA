...
public class Task1 {
    public static void main(String[] args) {
        ...
        phonBook.put("Igor", List.of("8 926 333 44 33", "8 926 222 22 99"));
        phonBook.put("Ira", List.of("8 926 333 41 55", "8 926 222 22 00"));
        phonBook.put("Igor", List.of("8 926 555 33 66", "8 926 222 22 44"));
        phonBook.put("Petr", List.of("8 926 666 33 77", "8 926 222 22 11"));
